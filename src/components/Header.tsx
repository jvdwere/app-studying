                ...
                <DrawerBody>
                  <Link href="/answers">
                    <Text cursor="pointer" marginLeft="12px">
                      <Button leftIcon={<GiBrazil />} variant="ghost">
                  ...
                  <Link href="/cars">
                    <Text cursor="pointer" marginLeft="12px" marginTop="8px">
                      <Button leftIcon={<FaCar />} variant="ghost">
                        Carros
                      </Button>
                    </Text>
                  </Link>
                  ...
                  <Link href="/presence-list">
                    <Text cursor="pointer" marginLeft="12px" marginTop="8px">
                      <Button leftIcon={<GoListOrdered />} variant="ghost">
                        Lista de Presença
                      </Button>
                    </Text>
                  </Link>
                  ...
                  <Link href="/movies">
                    <Text cursor="pointer" marginLeft="12px" marginTop="8px">
                      <Button leftIcon={<BiCameraMovie />} variant="ghost">
                        Filmes
                      </Button>
                    </Text>
                  </Link>
