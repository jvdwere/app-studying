				...
				<Box w="100%">
					<Box>
						<FormLabel>
							...
							<Box p="16px" fontSize="18pt" textAlign='center' marginLeft='15px' mt={{ base: '8px', md: '0px', }}>
								    <Box>Naturalidades do Brasil.</Box>


								<Card align='center' bg='#00AEAE' >
									<CardHeader>
								...
								<Card p='30px' bg='white' align='center' >
									<CardBody>
										<FormLabel>
											{estadoSelecionado && <Heading textAlign='center' >{estadoSelecionado}</Heading>}
										</FormLabel>
										<Box boxSize='sm' marginLeft='115px'>
											<Image
												borderRadius='full'
												w='250px'
